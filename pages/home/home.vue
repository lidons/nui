<template>
	<view>
		...
		<view class="header" :style="{ position: headerPosition }">
			<view class="scan"><view class="icon scan" @tap="scan"></view></view>
			<view class="input">
				<view class="icon search"></view>
				<input placeholder="睫毛膏" @tap="toSearch()" />
			</view>
			<view class="menu"><image mode="widthFix" src="../../static/face.png"></image></view>
		</view>
		<!-- 占位 -->
		...
		<view class="category">
			<view class="box">
				...
				<view class="dots">
					<view
						v-for="(page, pageindex) in categoryList"
						:key="pageindex"
		...
		<!-- 广告横幅 -->
		<view class="banner"><image mode="widthFix" src="../../static/banner.jpg"></image></view>
		<!-- 商品列表 -->
...
export default {
	data() {
		return {
			...
			pickList: [
				{
					goods_id: 0,
					img: '../../static/pick-img/p1.jpg',
					price: '￥168',
					slogan: '限时抢购'
				},
				{
					goods_id: 1,
					img: '../../static/pick-img/p2.jpg',
					price: '￥168',
					slogan: '精选商品'
				},
				{
					goods_id: 2,
					img: '../../static/pick-img/p3.jpg',
					price: '￥168',
					slogan: '今日疯抢'
				}
			],
	...
	onReachBottom() {
		...
		for (let i = 1; i <= 10; i++) {
			...
			let p = {
				goods_id: goods_id,
				img: '../../static/img/p' + (goods_id % 10 == 0 ? 10 : goods_id % 10) + '.jpg',
				name: '商品名称商品名称商品名称商品名称商品名称',
				price: '￥168',
				slogan: '1235人付款'
			};
